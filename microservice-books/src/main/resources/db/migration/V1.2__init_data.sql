...
insert into borrowings(date_borrowed, date_limit, date_returned,  renewed, id_book, id_type, id_user) values ('16/06/2018', '13/08/2018', '12/08/2018',  true, 1, 2, 1);
insert into borrowings(date_borrowed,date_limit, date_returned, renewed, id_book, id_type, id_user) values ('13/07/2019','13/08/2019', null,  false, 3, 3, 1);
insert into borrowings(date_borrowed,date_limit, date_returned, renewed, id_book, id_type, id_user) values ('13/02/2019','13/04/2019', null,  true, 4, 3, 1);
